                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="aa-product-view-content">
                                        ...
                                        <div class="aa-price-block">
                                            ...
                                            <p class="aa-product-avilability" style="margin: 20px 0">Tình trạng:
                                        ...
                                        <div class="aa-price-block" style="margin: 20px 0">
                                            <span class="aa-product-view-price">Tác giả : <span>
                                        ...
                                        <div class="aa-prod-view-bottom" style="margin-top: 100px">
                                            <a class="aa-add-to-cart-btn" href="#"
                                                style="color:#C92127;background-color:white;border:1px solid #C92127;border-radius:10px">Thêm
                                                vào giỏ hàng</a>
                                            <a class="aa-add-to-cart-btn" href="#"
                                                style="color:white;background-color:#C92127;border-radius:10px">Mua hàng</a>
