...
<section id="aa-product-category">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-md-push-0" style="background-color: white;margin-top:40px;border-radius:10px;margin-bottom:40px">

            <div style="background-color: #FCDDEF;padding: 0 20px;border-radius:10px;margin-top:45px">
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg" id="loadsort">

                @foreach($productAll as $product)

                <li style="width: 20%">
                  <figure>
                    <a class="aa-product-img" href="{{url('product/detail/'.$product->id)}}"><img src="{{$product->cover}}" alt="polo shirt img" width="100%"></a>
                    <figcaption>
